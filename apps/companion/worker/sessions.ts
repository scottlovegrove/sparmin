...
import type { LapGroup } from '../src/lib/session-payload'
import type { Db } from './db'

// Reading, editing and deleting a stored visit. Writing one lives in
// session-ingest.ts, which owns the two-source reconciliation.
